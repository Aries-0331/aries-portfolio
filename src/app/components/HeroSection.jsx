			...
			<div className="grid grid-cols-1 sm:grid-cols-12">
				<div className="col-span-7 text-center mt-8 sm:text-left sm:items-center lg:pl-6">
					<h1 className="flex flex-col justify-between  text-white text-3xl sm:text-4xl sm:leading-normal font-extrabold lg:text-6xl">
						<span className="text-transparent bg-clip-text bg-gradient-to-r from-[#CC8F6C] to-[#FDDAA8] py-2">
							Hello, I&apos;m Aries{" "}
						</span>
						<TypeAnimation
							sequence={[
					...
					<div className="mt-6 place-self-end">
						<Link
							href="/#contact"
							className="inline-block px-6 py-3 w-full sm:w-fit rounded-full mr-4 bg-gradient-to-br from-[#CC8F6C]  to-[#FDDAA8] hover:bg-slate-100 text-white"
						>
							Hire Me
						</Link>
						<button className="px-1 py-1 w-full sm:w-fit rounded-full bg-gradient-to-br from-[#CC8F6C]  to-[#FDDAA8]  text-white border border-white mt-3">
